...
RGB = imread('Cookie4.jpg');
imshow(RGB);
% have to inverted image due to light background
inverted = imcomplement(RGB);
figure, imshow(inverted)
% create grayscale image
gray = rgb2gray(inverted);
...
se = strel('disk', 50); % structuring element; "paintbrush"
...
threshold = 0.70; % arbitrary value (change as needed)
